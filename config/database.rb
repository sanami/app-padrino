...
database_name = case Padrino.env
  when :development then 'banners_development'
  when :production  then 'banners_production'
  when :test        then 'banners_test'
end
...
#     sessions:
#       default:
#         database: banners_development
#         hosts:
#           - localhost:27017
#   production:
#     sessions:
#       default:
#         database: banners_production
#         hosts:
#           - localhost:27017
#   test:
#     sessions:
#       default:
#         database: banners_test
#         hosts:
#           - localhost:27017
#
#
